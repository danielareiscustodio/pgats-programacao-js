...
// == - compara valores (coersao de tipo)
// === - estritamente igual (tudo vai estar correto desde tipo ate valor)
// ex: palavras.lenght === 1 (compara se o tamanho da palavra (ex 3) é igual a 1. Se nao for ele ja barra e se for ele continua)

/**
 * Operadores - comparaçao, logica e aritmetica
 * VALOR A maior que VALOR B
 * VALOR A menor que VALOR B
 * == -> VARIAVEL A 'possui o mesmo valor que' VARIAVEL B
 * === -> VARIAVEL A 'possui o mesmo valor E possui o mesmo tipo de dado que' VARIAVEL B
